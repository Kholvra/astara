...
export const Module2Search: React.FC<Module2Props> = ({
    ...
    // Helper standarisasi subtitle & icon: "Jenis • Rute"
    const getTransitMeta = (stop: SearchResultItem) => {
        ...
        if (isMikro) {
            ...
            return {
                ...
                themeClass: "bg-[#EBF5FB] text-[#0085CA]", // Biru
            };
        }
        ...
        if (isNonBRT) {
            ...
            return {
                ...
                themeClass: "bg-[#E8F7EE] text-[#00A651]", // Hijau
            };
        }
        ...
        return {
            ...
            themeClass: "bg-[#FDECEE] text-[#E11931]", // Merah
        };
    };
                    ...
                    {ambiguousItem ? (
                        ...
                        <div className="p-4">
                            <div className="border-b border-slate-100 pb-2">
                                <span className="text-[11px] font-bold uppercase tracking-wider text-slate-400">PILIH ARAH PERON</span>
                                <h3 className="mt-0.5 text-[15px] font-bold text-slate-900">{ambiguousItem.title}</h3>
                            </div>
                                ...
                                {ambiguousItem.platforms?.map((plat) => (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="text-[11px] font-medium text-slate-500">{plat.label.split(" • ")[0]}</div>
                                                <div className="text-[13.5px] font-bold text-slate-900">{plat.label.split(" • ")[1] ?? plat.label}</div>
                                            </div>
                                        </div>
                                    </button>
                                ))}
                                ...
                                <div className="pt-4 pb-1">
                                    ...
                                    {filteredTransit.map((stop, idx, arr) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                {/* Icon + Teks Judul & Rute */}
                                                <div className="flex min-w-0 flex-1 items-center gap-3 pr-2">
                                                    <div className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl ${meta.themeClass}`}>
                                ...
                                <div className="pt-3 pb-1">
                                    ...
                                    {filteredLandmarks.map((landmark, idx, arr) => (
                                        ...
                                        >
                                            ...
                                            {/* Garis Pembatas buat konten search */}
                                            {idx < arr.length - 1 && (
                                                <div className="absolute bottom-0 left-5 right-5 h-[1px] bg-[#E2E8F0]" />
                                            )}
                                        </article>
